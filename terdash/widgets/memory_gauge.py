"""Memory usage arc gauge widget — QPainter arc dashboard."""

from PySide6.QtCore import Qt, QTimer, QRectF
from PySide6.QtGui import QPainter, QColor, QFont, QPen
from PySide6.QtWidgets import QWidget

from terdash.services.system_service import get_memory_info
...
class MemoryGauge(QWidget):
    """Real-time memory usage arc gauge."""
    ...
    def _update(self):
        ...
        self._percent = info["percent"]
        self._used_gb = info["used_gb"]
        self._total_gb = info["total_gb"]
        self.update()
    ...
    def paintEvent(self, event):
        ...
        painter.drawText(
            label_rect, Qt.AlignHCenter | Qt.AlignTop,
            f"内存 {self._used_gb:.1f}/{self._total_gb:.0f}G"
        )
